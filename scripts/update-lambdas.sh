...
&& aws lambda update-function-code --function-name WalterAPI-GetUser-dev --s3-bucket walter-backend-src --s3-key walter-backend.zip --no-cli-pager \
&& echo Updating WalterAPI GetStock source code with artifact from S3 \
&& aws lambda update-function-code --function-name WalterAPI-GetStock-dev --s3-bucket walter-backend-src --s3-key walter-backend.zip --no-cli-pager \
...
&& aws lambda update-function-code --function-name WalterAPI-GetPrices-dev --s3-bucket walter-backend-src --s3-key walter-backend.zip --no-cli-pager \
...
&& aws lambda update-function-code --function-name WalterAPI-GetPortfolio-dev --s3-bucket walter-backend-src --s3-key walter-backend.zip --no-cli-pager \
...
&& aws lambda update-function-code --function-name WalterAPI-GetNewsletters-dev --s3-bucket walter-backend-src --s3-key walter-backend.zip --no-cli-pager \
